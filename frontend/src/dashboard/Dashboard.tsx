const Dashboard = () => {
	return (
		<>
			<nav className="shadow-lg md:text-xl max-md:bottom-2 flex md:text-lg lg:text-base fixed md:top-5 inset-x-5 md:inset-x-10 items-center justify-around text-white py-2 md:py-4 bg-blue-900 rounded-2xl">
				<a href="/">
